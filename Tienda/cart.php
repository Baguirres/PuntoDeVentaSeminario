              ...
              <table class="table table-bordered">
                ...
                ?>
                  <tr>
                    ...
                    <td>Q<?php echo $arregloCarrito[$i]['Precio']; ?></td>
                    <td>
                    ...
                    <td class="cant<?php echo $arregloCarrito[$i]['Id']; ?>">
                      Q<?php echo $arregloCarrito[$i]['Precio'] * $arregloCarrito[$i]['Cantidad']; ?></td>
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black" id="subtotal">Q<?php echo $total;?></strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black" id="total">Q<?php echo $total;?></strong>
                  </div>
                </div>

                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Proceder a pago</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    $(document).ready(function(){
      ...
      function incrementar(cantidad, precio, id){
        ...
        $.ajax({
          ...
          $("#total").text("Q"+respuesta);
          $("#subtotal").text("Q"+respuesta);
        });
      }
    });
  </script>
